...
def main_cycle(n_cycles, n_particles, lr, gradient_iterations):
    ...
    g_cloud = Cloud(n_particles, n_spins, beta, coeffs_types=["z", 'x', 'zz'])
    MSE = []
    ...
    print(f"z_t = {z_t}, x_t = {x_t}")
    print(f"z_g = {hamiltonian_g.z}, x_g = {hamiltonian_g.x}")
    return MSE, g_cloud


if __name__ == '__main__':
    n_cycles = 20
    MSE, g_cloud = main_cycle(n_cycles=n_cycles, n_particles=500, lr=0.5, gradient_iterations=500)
